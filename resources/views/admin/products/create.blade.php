...
<div class="animate-in fade-in duration-300 relative w-full pb-10" x-data="productForm()">
    ...
    <nav class="flex items-center space-x-1.5 text-[13px] font-medium mb-4" aria-label="Breadcrumb">
        ...
        <span class="text-gray-900 font-semibold">Create Product</span>
    </nav>

    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Create Product</h1>
            <p class="text-sm text-gray-500 mt-1">Add a new product to your inventory.</p>
        </div>
            ...
            <div class="px-6 py-6 pb-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        <h3 class="text-xs font-semibold text-gray-500 tracking-wider uppercase">Basic Information</h3>
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 pt-2">
                        <h3 class="text-xs font-semibold text-gray-500 tracking-wider uppercase">Inventory & Pricing</h3>
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 pt-2 border-t border-gray-100 mt-4">
                        <label class="flex items-center space-x-3 cursor-pointer group w-max">
                            <div class="relative flex items-center">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-white border-gray-300 rounded focus:ring-blue-600 focus:ring-2 cursor-pointer transition-colors">
                            </div>
                            <div>
