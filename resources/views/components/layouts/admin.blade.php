...
<head>
    ...
    <title>{{ $title ?? config('app.name', 'DVS Jaya') }}</title>
    ...
    <div class="flex h-screen overflow-hidden bg-white" x-data="{ sidebarExpanded: true }">
        ...
        <aside
            ...
            <nav class="flex-1 px-3 space-y-4 pb-8 mt-4 overflow-y-auto w-full transition-all">
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <a href="/admin/stores" wire:navigate
                            class="group flex items-center py-1.5 text-[14px] font-medium transition-all duration-200 border
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('admin.pos.terminal') }}" wire:navigate
                            class="group flex items-center py-1.5 text-[14px] font-medium transition-all duration-200 border
                        ...
                        <a href="#"
                            class="group flex items-center py-1.5 text-[14px] font-medium transition-all duration-200 border text-gray-600 border-transparent hover:bg-gray-100 rounded-lg"
                            :class="sidebarExpanded ? 'px-2.5 justify-start' : 'px-0 justify-center'"
                            title="Sales History">
                            <svg class="w-[18px] h-[18px] shrink-0 text-gray-400 group-hover:text-gray-500"
                                :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-white flex flex-col relative w-full">
            ...
            <header
                ...
                <div class="ml-4 font-semibold text-gray-900">DVS Jaya</div>
            </header>
